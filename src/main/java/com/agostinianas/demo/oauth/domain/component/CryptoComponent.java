package com.agostinianas.demo.oauth.domain.component;


import com.agostinianas.demo.core.domain.exception.CryptoException;
...
public class CryptoComponent {
    ...
    private static Key generateKey(String secret) throws Exception {
        ...
        return new SecretKeySpec(decoded, TRANSFORMATION);
    ...
    public String encryptFromString(String plainText, String encryptSecretKey) {
        ...
        try {
            ...
            log.info("Cipher Text: Encryption of str = {} ", encrStr);
            log.info("Decryption of str = {}", decrStr);

            return encrStr;

        } catch (Exception e) {
            throw new CryptoException("Error while encrypting: ", e);
        }
    ...
    public String decryptString(String cipherText, String encryptSecretKey) {
        ...
        log.info("EncodedBase64Key = {}", encodedBase64Key);
        log.info("Cipher Text: Encryption of str = {}", cipherText);
        log.info("Decryption of str = {}", decrStr);
    ...
    public static String encryptFromString2(String plainText, String encryptSecretKey)
            throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException,
            InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        ...
        final byte[][] keyAndIVEncryption = GenerateKeyAndIV(32, 16, 1, saltDataEncryption, encryptSecretKey.getBytes(StandardCharsets.UTF_8), md5);
    ...
    public static String decryptString2(String cipherText, String encryptSecretKey)
            throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException,
            InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        byte[] cipherData = Base64.getDecoder().decode(cipherText);
        byte[] saltData = Arrays.copyOfRange(cipherData, 8, 16);
        MessageDigest md5 = MessageDigest.getInstance("MD5");
        final byte[][] keyAndIV = GenerateKeyAndIV(32, 16, 1, saltData, encryptSecretKey.getBytes(StandardCharsets.UTF_8), md5);
