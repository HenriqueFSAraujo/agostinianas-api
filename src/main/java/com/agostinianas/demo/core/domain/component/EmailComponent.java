package com.agostinianas.demo.core.domain.component;
    ...
    public static String getTemplateSendToken(String name, String token) {
        ...
        <html>
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                ...
                <p style="text-align: center; font-size: 24px; font-weight: bold; color: #4CAF50;">{{TOKEN}}</p>
                <p>Use este token para concluir seu cadastro no sistema <b>hubRecupera</b>.</p>
